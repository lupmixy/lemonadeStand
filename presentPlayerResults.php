  ...
  <body id=background>
    ...
    <div class="container">
      ...
      <div class="masthead">
        ...
        <div id="txtHint" style="background-color:#CCFFCC">
          <div align="center">
             <nav>
                 <ul class="pagination">
...
<div id="dataTable">
          <table align="center" class="table table-bordered table-hover table-condensed" style="width:95%">
            ...
            <div class="row">             	
            	<div align="center">  
            		<div class="col-md-12">
                      <h1 id="blueButton"><a href="player.php" id="navButton" role="button" class="btn btn-lg  btn-primary" >Log In and Play Again</a></h1>
                  </div>
                </div>
            </div>
